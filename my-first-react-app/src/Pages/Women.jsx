    ...
    <> 
       <div className="w-full">
        <div className="flex justify-center px-4 md:px-10 lg:px-20">
            <img 
               src={women_banner} alt="men banner" className="w-full max-w-\[1200px\] mt-9 h-auto ny-6" />
        </div> 
        ...
        {/* product grid  */}
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-y-12 gap-x-12 px-6 md:px-12 lg:px-60 my-10 justify-items-center">
